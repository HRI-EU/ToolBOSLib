...
void Test_RTTimer( CuTest *tc )
{
    ...
    ANY_LOG( 5, "Elapsed start/stop time is %llu nanoseconds",
             ANY_LOG_INFO, elapsed );
    ANY_LOG( 5, "Min start/stop time is %llu nanoseconds",
             ANY_LOG_INFO, minTime );
    ANY_LOG( 5, "Average start/stop time is %llu nanoseconds",
             ANY_LOG_INFO, averangeTime );
    ANY_LOG( 5, "Max start/stop time is %llu nanoseconds",
             ANY_LOG_INFO, maxTime );
    ANY_LOG( 5, "Total start/stop time is %llu nanoseconds (%lu days %lu:%lu:%lu.%06lu)",
